...
<head>
	...
	<title>Compañía | Sintrave Elevadores</title>
	<!-- Seo -->
...
<body>
	...
	<div class="header_page">
		<h2 class="h_title">Información Empresarial</h2>
	</div>
	<div id="submenu">
		<ul class="menu_sub">
			<li>
	...
	<section class="n_content">
		<article id="nosotros" class="c_articulos c_articulos_oscuro">
		...
		<article id="garantia" class="c_articulos c_articulos_blanco">
			<div class="ca_contenido">
				<div class="left">
					<figure class="cac_img">
			...
			<div class="ca_contenido">
				<div class="left">
					...
					<ul>
						...
						<li><span class="visto"></span>Casco de protección</li>
						<li><span class="visto"></span>Gafas de protección</li>
						<li><span class="visto"></span>Guantes</li>
						<li><span class="visto"></span>Mascarillas</li>
						<li><span class="visto"></span>Tapones auditivos y orejeras</li>
						<li><span class="visto"></span>Zapatos de seguridad</li>
					</ul>
				</div>
				<div class="right">
					<figure class="cac_img">
